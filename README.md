...
9.	Check the results: Use the checkResult function to verify that the output array calculated on the GPU matches the output array that on the host.
...
// malloc host memorycpuSecondh_A, *h_B, *hostRef, *gpuRef;
